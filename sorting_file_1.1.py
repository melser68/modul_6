...
import sys
import re
import rarfile #Не реалізовано
import zipfile
import lzma    #Не реалізовано
import py7zr
import rarfile
import os
...
#Бібліотека розширень для сортування
dict_extentions ={
                  'images':list_img, 
...
dict_sorting_files = {
                      'images_s':rez_imgs, 
                      'archive_s':rez_archives, 
                      'video_s':rez_videos, 
                      'document_s':rez_documents,
                      'music_s':rez_musics, 
                      'other_s':rez_others
                      }
...
#Бібліотека знайдених розширень
dict_extentions_rez ={
                      'img_ex_rez':suffix_imgs, 
                      'arch_ex_rez':suffix_archives, 
                      'videos_ex_rez':suffix_videos,
                     }
